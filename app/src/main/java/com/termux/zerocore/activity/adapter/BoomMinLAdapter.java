 ...
 **/
public class BoomMinLAdapter extends RecyclerView.Adapter<MinLViewHolder> {

    private List<MinLBean.DataNum> dataNum;

    private  Activity activity;

    public BoomMinLAdapter(List<MinLBean.DataNum> dataNum, Activity activity){
    ...
    public MinLViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MinLViewHolder(UUtils.getViewLayViewGroup(R.layout.item_boom_migl,parent));
    }
